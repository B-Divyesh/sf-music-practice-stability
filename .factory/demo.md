...
- URL: `https://music-practice-stability.sociobot.in/demo`
- Local URL: `http://127.0.0.1:4173/demo`
- Direct query-free route: `/demo`
...
The service worker packages the sample in JavaScript, so `/demo` can reload
